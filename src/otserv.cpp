...
void mainLoader(int, char *[], ServiceManager *services)
{
...
#endif
#else
	SPDLOG_INFO("Forgotten Land - Based on OTServBR Global / TFS 1.3\n");
#endif
	...
	SPDLOG_INFO("Compiled on {} {} for platform {}", __DATE__, __TIME__, platform);

#if defined(LUAJIT_VERSION)
	SPDLOG_INFO("Linked with {} for Lua support\n", LUAJIT_VERSION);
#endif

	SPDLOG_INFO("Developed by: {}", STATUS_SERVER_DEVELOPERS);
	SPDLOG_INFO("Modified by Natan Rauber\n");
