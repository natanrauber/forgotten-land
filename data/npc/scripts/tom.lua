...
local function greetCallback(cid)
	...
	elseif player:getStorageValue(Storage.TheRookieGuard.Mission06) == 3 then
		...
		npcHandler:setMessage(
			MESSAGE_GREET,
			"Hey there, |PLAYERNAME|. I'm Tom the tanner. If you have fresh {corpses}, leather, paws or other animal body parts, {trade} with me."
		)
	end
	return true
end
...
keywordHandler:addKeyword(
	{"merchant"},
	StdModule.say,
	{npcHandler = npcHandler, text = "{Dixi} and {Lee'Delle} sell my leather clothes in their shops."}
)
keywordHandler:addKeyword(
	{"tanner"},
	StdModule.say,
...
keywordHandler:addKeyword(
	{"information"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Do I look like a tourist information centre? Go ask someone else."}
)
keywordHandler:addKeyword(
	{"help"},
	StdModule.say,
...
keywordHandler:addKeyword(
	{"fresh"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Fresh means: shortly after their death."}
)
keywordHandler:addKeyword(
	{"how", "are", "you"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Much to do these days."}
)
keywordHandler:addKeyword(
	{"monster"},
	StdModule.say,
...
keywordHandler:addKeyword(
	{"dungeon"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Dungeons can be dangerous without proper {equipment}."}
)
keywordHandler:addKeyword(
	{"equipment"},
	StdModule.say,
...
keywordHandler:addKeyword(
	{"time"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Sorry, I haven't been outside for a while, so I don't know."}
)

keywordHandler:addKeyword(
	{"troll"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Troll leather stinks. Can't use it."}
)
keywordHandler:addKeyword(
	{"orc"},
	StdModule.say,
	{npcHandler = npcHandler, text = "I don't buy orcs. Their skin is too scratchy."}
)
...
keywordHandler:addKeyword(
	{"backpack"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Nope, sorry, don't sell that. Go see {Al Dee} or {Lee'Delle}."}
)
...
keywordHandler:addKeyword(
	{"armor"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Nope, sorry, don't sell that. Ask {Dixi} or {Lee'Delle}."}
)
...
keywordHandler:addKeyword(
	{"weapon"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Nope, sorry, don't sell that. Ask {Obi} or {Lee'Delle}."}
)
...
keywordHandler:addKeyword(
	{"amber"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Now that's an interesting woman."}
)
keywordHandler:addKeyword(
	{"billy"},
	StdModule.say,
	{npcHandler = npcHandler, text = "He's a better cook than his cousin {Willie}, actually."}
)
keywordHandler:addKeyword(
	{"willie"},
	StdModule.say,
	{npcHandler = npcHandler, text = "I kinda like him. At least he says what he thinks."}
)
keywordHandler:addKeyword({"tom"}, StdModule.say, {npcHandler = npcHandler, text = "Yep."})
keywordHandler:addKeyword(
	{"seymour"},
	StdModule.say,
	{npcHandler = npcHandler, text = "He sticks his nose too much in books."}
)
keywordHandler:addKeyword(
	{"zirella"},
	StdModule.say,
	{npcHandler = npcHandler, text = "My mother?? Did you meet my mother??"}
)
keywordHandler:addKeyword(
	{"santiago"},
	StdModule.say,
	{npcHandler = npcHandler, text = "I don't have a problem with him."}
)
...
keywordHandler:addKeyword(
	{"dixi"},
	StdModule.say,
	{npcHandler = npcHandler, text = "She buys my fine leather clothes."}
)
keywordHandler:addKeyword(
	{"loui"},
	StdModule.say,
	{npcHandler = npcHandler, text = "I wonder what spectacular monsters he has found."}
)
keywordHandler:addKeyword(
	{"lee'delle"},
	StdModule.say,
	{npcHandler = npcHandler, text = "Her nose is a little high in the air, I think. She never shakes my hand."}
)
keywordHandler:addKeyword(
	{"hyacinth"},
	StdModule.say,
	{npcHandler = npcHandler, text = "I wonder if he's angry because his potion monopoly fell."}
)
keywordHandler:addKeyword(
	{"cipfried"},
	StdModule.say,
	{npcHandler = npcHandler, text = "I'm not what you'd call a 'believer'."}
)
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "cough syrup") then
		npcHandler:say(
			"I had some cough syrup a while ago. It was stolen in an ape raid. I fear if you want more cough syrup you will have to buy it in the druids guild in carlin.",
			cid
		)
	elseif msgcontains(msg, "addon") then
		if player:getStorageValue(Storage.OutfitQuest.DruidBodyAddon) < 1 then
			npcHandler:say(
				"Would you like to wear bear paws like I do? No problem, just bring me 50 bear paws and 50 wolf paws and I'll fit them on.",
				cid
			)
