	...
	Quests = {
		...
		[5] = {
			...
			missions = {
				[1] = {
					...
					startValue = 1,
					endValue = 2,
					description = "The dwarf Xelvar has sent you to meet the gnome Gnomerik. He can recruit you to the Bigfoot Company. Use the teleporter near Xelvar to enter the gnomish base and start looking for Gnomerik."
				},
				[2] = {
					name = "A New Recruit",
					storageId = Storage.BigfootBurden.QuestLine,
				...
				[6] = {
					...
					description = function(player)
						return string.format(
							"Hit five targets in a row. Don't hit an innocent target as it will reset your hit counter. %d / 5",
				...
				[12] = {
					...
					description = function(player)
						return string.format(
							"Use the repair crystal to repair five damaged blue crystals in the crystal caves. Damaged crystals will not glow.\n%d / 5",
				...
				[13] = {
					...
					description = function(player)
						return string.format(
							"Kill crystal crushers and use the discharger item on the corpse to collect their charges. Gather 7 charges and report back. %d / 7",
		...
		[12] = {
			...
			missions = {
				...
				[3] = {
					...
					description = function(player)
						return string.format(
							"You are Big Game Hunter in the Paw and Fur hunting elite. You currently have %d Paw and Fur points.",
							(math.max(player:getStorageValue(2500), 0))
						)
					end
				},
				[4] = {
					...
					description = function(player)
						return string.format(
							"You are Trophy Hunter in the Paw and Fur hunting elite. You currently have %d Paw and Fur points. Ask Grizzly Adams for 'special task' he might have something for you.",
							(math.max(player:getStorageValue(2500), 0))
						)
					end
				},
				[5] = {
					...
					description = function(player)
						return string.format(
							"You have obtained the highest possible rank in the Paw and Fur hunting elite, you are Elite Hunter. You currently have %d Paw and Fur points. Ask Grizzly Adams for 'special task' he might have something for you.",
							(math.max(player:getStorageValue(2500), 0))
						)
					end
				},
				...
				[8] = {
					...
					startValue = 1,
					endValue = 2,
					description = "Grizzly told you about the Snapper, a crocodile that already killed many citizens of Port Hope. Try find its hideout and kill it."
				},
				[9] = {
		...
		[13] = {
			...
			missions = {
				...
				[9] = {
					name = "Mage and Summoner Outfit Quest (Wand)",
				...
				[10] = {
					name = "Mage and Summoner Outfit Quest (Fluid Belt)",
			...
			missions = {
				...
				[2] = {
					...
					states = {
						...
						[2] = "You know that the branches Zirella needs might be gotten from dead trees in the forest south of here, but you don't know the details yet. You should talk to her.",
						[3] = "You have learned that you can 'Use' a dead tree to break a branch, but there is some information missing. You should talk to Zirella again.",
						[4] = "You have learned that you can push the branch which you've broken from a dead tree by 'Drag and Drop', but you still need some information. You should talk to Zirella again.",
						...
						[6] = "Go into the forest south of here and look for trees without leaves. 'Use' one to break a branch from it, then drag and drop the branch back to her cart and 'Use' it with the cart.",
		...
		[25] = {
			...
			missions = {
				...
				[10] = {
					...
					startValue = 1,
					endValue = 1,
					description = "You now have permission to use the Magic Carpet on the mountain above Farmine, Cael now accepts more Tomes of Knowledge from you and you got the Warmaster Outfit!"
				},
				[11] = {
		...
		[27] = {
			...
			missions = {
				...
				[3] = {
					...
					startValue = 1,
					endValue = 1,
					description = "After helping Jack Fate to collect the 30 woodpieces, Jack Fate in Liberty Bay will bring you to Goroma."
				},
				[4] = {
					...
					startValue = 1,
					endValue = 1,
					description = "After arranging a date for Marina and Ocelus, you are allowed to use Marina's sea turtles. They will bring you to the idyllic Laguna Islands."
				},
				[5] = {
					...
					startValue = 1,
					endValue = 1,
					description = "After earning the trust of the governor's daughter Eleonore, Captain Waverider in Liberty Bay will bring you to Meriana if you tell him the secret codeword 'peg leg'."
				},
				[6] = {
					...
					startValue = 1,
					endValue = 1,
					description = "After convincing the people in Sabrehaven that you are a trustworthy hero, Sebastian will sail you to Nargor."
				},
				[7] = {
				...
				[8] = {
					...
					endValue = 3,
					states = {
						[1] = "Buy a fire bug at Liberty Bay and infiltrate Nargor. Find the pirates' harbor and use the fire bug to sabotage their catapult there.",
						[2] = "You were able to sabotage the catapult in the pirate's harbor. Report back to Ray Striker to tell him about mission.",
				...
				[13] = {
					...
					startValue = 18,
					endValue = 19,
					description = "You have finished eight missions. People in Sabrehaven seem to trust you, but there is still one last mission left."
				},
				[14] = {
		...
		[29] = {
			...
			missions = {
				...
				[4] = {
					...
					endValue = 3,
					states = {
						[1] = "Rashid have ordered a special elven vase from Briasol in Ab'Dendriel.     He asks you to buy it from Briasol and bring it back. But you should be carefully, since the vase is very fragile.",
		...
		[33] = {
			...
			missions = {
				...
				[11] = {
					...
					endValue = 4,
					states = {
						[0] = "A pirate told you about an evil artifact down in the crystal caves under Nargor. It is a big crystal that affects the caves in a negative manner. Perhaps a jarring,very loud sound could destroy it.",
						[1] = "You found an old inscription to a mysterious recipe: 'vial of emb... fl... and mix ... a medusa's bl... Then ... the dust of ... crystal ... get Medusa's Ointm... able to unpetrify ...'",
						[2] = "You mixed the proper ingredients to create a special salve. The Medusa's Ointment. With this balm you may unpetrify a petrified object.",
						[3] = "With the Medusa's Ointment you unpetrified a banshee's scream near the evil crystal. Thus the baleful artefact was destroyed. You should return to One-Eyed Joe.",
						[4] = "You have completed the Quest!"
					}
				}
			}
		...
		[36] = {
			...
			missions = {
				...
				[6] = {
					...
					description = function(player)
						return string.format(
							"Explore the area where Zlak is to find Lizard Magistratus and kill 4 of them. You currently have %d killed. Report back to Zlak if you finished it.",
				...
				[7] = {
					...
					description = function(player)
						return string.format(
							"Explore the area where Zlak is to find Lizard Noble and kill 6 of them. You currently have %d killed. Report back to Zlak if you finished it.",
		...
		[37] = {
			...
			missions = {
				[1] = {
					...
					startValue = 1,
					endValue = 3000,
					description = "Five Juicy roots from the outskirts of Rathleton may already help feed the poor. Try to find a city official to deliver them to or go to the Rathleton poor house."
				}
			}
		},
		[38] = {
			...
			missions = {
				...
				[3] = {
					...
					endValue = 1522018605,
					states = {
						[1] = "You defeated the Thorn Knight and shattered the root of evil with all your might. The honor of being a guardian of the glade indeed comes with pride as well as responsibility."
					}
				},
				[4] = {
		...
		[39] = {
			...
			missions = {
				...
				[2] = {
					...
					startValue = 0,
					endValue = 20,
					description = "Treasure is the favorite of the dragon lords. Find and take Kalyassa's treasures spread across the world."
				},
				[3] = {
					name = "Knowledge",
					...
					startValue = 0,
					endValue = 1,
					description = "You learned that frost dragon's incitement is the thirst for knowledge, perhaps if you bring some to Gelidrazah's you'll meet him."
				},
				[4] = {
					name = "Life",
					...
					startValue = 0,
					endValue = 3,
					description = "Undead dragons aspires for life. No better way to see life as it grows around the world, is there?"
				}
			}
		},
		[40] = {
			...
			missions = {
				...
				[4] = {
					...
					states = {
						...
						[3] = function(player)
							return ("You survived the Trial. Barkless now have the right to see the cult leader but a powerful relic is sealing the path. Barkless markings broken to reverse the power of the cult object:  %d of 10"):format(
				...
				[5] = {
					...
					states = {
						...
						[3] = function(player)
							return ("While rubbish, the amulet you equipe emits a strange aura of splendour. You feel an urge to fulfill the amulets hunger for especific deaths... Exorcisms: %d/5 "):format(
		...
		[41] = {
			...
			missions = {
				[1] = {
					...
					states = {
						[1] = function(player)
							return ("Destroy makeshift homes of the Lost to force them to fight you! Try making some prisoners in the progress and report back to Klom Stonecutter.\n\nLost Exiles: %d/20\nPrisoners (bonus): %d/3"):format(
				...
				[2] = {
					...
					states = {
						[1] = function(player)
							return ("Klome Stonecutter sent you on a grave mission to exterminate large populaces of subterranian life. Looks like the dwarves make short work of the deep intruders.\n\nSubterranean organisms: %d/50"):format(
				...
				[4] = {
					...
					states = {
						...
						[2] = function(player)
							return ("You found the old gnome trail where ordnance for the gnome outpost arrive, escort them and their pack animals to safety and return to Gnomus.\n\nRescued gnomes: %d/5\nRescued animals: %d/3"):format(
				...
				[5] = {
					...
					states = {
						[1] = function(player)
							return ("Chart the area around the deep base for Gnomus. Look for especific landmarks: \n\nOld Gate: %d/1\nThe Gaze: %d/1\nLost Ruin: %d/1\nOutpost: %d/1\nBastion: %d/1\nBroken Tower: %d/1"):format(
				...
				[6] = {
					...
					states = {
						[1] = function(player)
							return ("You found the mine shaft. Burn all the growth and report back to Lardoc Bashsmite! \n\nFirst Room: %d/1\nSecond room: %d/1\nThird room: %d/1\nFourth room: %d/1\nFifth room: %d/1"):format(
				...
				[7] = {
					...
					states = {
						[1] = function(player)
							return ("Lardoc asked you to follow a plan of the gnomes to stop the deep threat by trying to neutralise diremaw spawn with pesticies. Diremaws lay eggs inside corpses of their skin. \n\nNeutralised: %d/20"):format(
		...
		[43] = {
			...
			missions = {
				[1] = {
					...
					endValue = 2,
					description = function(player)
						return ("You are exploring the Kha'zeel Dragon Lairs. Others obviously found a terrible end here. But the dragon hoards might justify the risks. You killed %d/50 dragons and dragon lords."):format(
		...
		[44] = {
			...
			missions = {
				[1] = {
					...
					startValue = 1,
					endValue = 2,
					description = "You have reached the Outpost, where young heroes are trained in combat and hunting. When you have reached level 8 at least, you can leave for the Mainland. Talk to Inigo if you have questions."
				},
				[2] = {
			...
			missions = {
				...
				[2] = {
					...
					states = {
						...
						[2] = "You retrieved one stone from the big pile. Find a catapult to use it on.",
						[3] = "You loaded a stone on one of the catapults. One more to go! Find another catapult to load with a heavy stone.",
						[4] = "Two of the four catapults are loaded. That should be enough to build up a decent defence. Return to Vascalir to turn in your quest.",
				...
				[4] = {
					...
					states = {
						...
						[2] = "Lily gave you a bag with fresh herbs that need to be delivered to Hyacinth outside of the village. Leave the village to the north and walk east to find his lab.",
						[3] = "You've delivered the fresh herbs to Hyacinth. He still has a reward for you though - make sure to talk to him again!",
						[4] = "Hyacinth has another reward for you - make sure to talk to him again.",
						[5] = "You've delivered the herbs to Hyacinth and got a reward. Return to Vascalir.",
				...
				[5] = {
					...
					states = {
						...
						[5] = "Vascalir took the sample from you. He still has a reward for you.",
				...
				[6] = {
					...
					states = {
						...
						[5] = "You managed to get out of the wolves' den. Return to Tom to finish your mission.",
						[6] = "Tom gave you a pair of leather boots as reward for your good work. Vascalir surely has a new mission for you now."
					}
				},
				[7] = {
					...
					states = {
						...
						[2] = "You found the library, find the book of orc language before the shelves burn to ashes.",
						[3] = "You found the book of orc language, return to Vascalir before you get hurt.",
						[4] = "You've done all you could - but unfortunately the book is lost. No need to lose heart though - there is still hidden knowledge about the orc language in the village, and the next mission awaits."
					}
				},
				[8] = {
				...
				[12] = {
					...
					states = {
						...
						[3] = "You've knocked out the orc guard. Sneak into the fortress before he wakes up.",
						...
						[5] = "You managed to sneak into the fortress. Use the fleshy bone on the elite orc guard to create a distraction!",
						[6] = "The guard is indeed very distracted. This is the perfect time to enter the lower levels of the orc fortress.",
						...
						[15] = "You've vanquished Kraknaknork and brought peace to the village of Rookgaard."
					}
				}
			}
		}
